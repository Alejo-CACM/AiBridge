...
class AibridgeProductpreviewupdateModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        try {
            ...
            $preview = (new AiBridgeProductPreview())->build($productId, $payload, $languageId, $shopId);
            ...
            $this->sendJson(200, array(
                ...
                'data' => array(
                    ...
                    'product_date_upd_snapshot' => $preview['product_date_upd_snapshot'],
            ...
            $this->sendJson(500, array(
                'success' => false,
                'error' => array(
                    'code' => 'product_preview_internal_error',
                    'message' => 'Product preview could not be generated.',
                ),
            ));
        }
    }
