...
require_once dirname(__FILE__) . '/../../classes/AiBridgeEmailSendPreview.php';
...
class AibridgeEmailsendpreviewModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        try {
            ...
            if (!$preview['valid']) {
                $this->sendJson(400, array(
                    'success' => false,
                    'error' => array('code' => 'invalid_payload', 'message' => 'Invalid email send payload.'),
                    'errors' => $preview['errors'],
                ));
            }

            $employeeId = $this->module->getAuthenticatedEmployeeId();
            $request = AiBridgeApprovalRequest::createPendingEmailSend(
                $preview,
            ...
            $this->sendJson(500, array(
                'success' => false,
                'error' => array('code' => 'email_send_preview_internal_error', 'message' => 'Email send preview could not be generated.'),
            ));
        }
    }
